...
class LeNet5:
    ...
    def __init__(self, input_dim=(3, 32, 32),
        ...
        self.layers['BatchNum1'] = BatchNormalization(gamma=1, beta=0)
        ...
        self.layers['BatchNum2'] = BatchNormalization(gamma=1, beta=0)
    ...
    def accuracy(self, x, t, batch_size=32):  # 여기 배치사이즈도 바꿈
